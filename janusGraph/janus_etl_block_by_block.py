...
def get_blocks_range(client, partition: str, block_number):
    """
...
def main():
    ...
    parser.add_argument("--block-number", help="block number to process (for testing)")
    ...
    for partition in partitions:
        ...
        try:
            blocks = get_blocks_range(ch, partition, args.block_number)
